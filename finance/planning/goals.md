...
| --- | ---: | ---: | --- |
| Group AA | $2,783.74 | 4.28% EIR | Included in the automatic avalanche payment. |
| Group AB | $3,506.65 | 2.50% EIR | Included in the automatic avalanche payment. |
| Group AC | $4,335.00 | 3.48% EIR | Included in the automatic avalanche payment. |
| Group AD | $3,470.80 | 4.74% EIR | Included in the automatic avalanche payment. |
...
- Bailey's ring is not yet an active debt.
- Target financing structure: 12-month 0% APR promotional offer.
- Target purchase range: $2,000-$3,000.
- Target payoff window: 10 months, leaving a 2-month buffer before promotional interest could be charged.
