...
## Current Post-Tax Paycheck Allocation

Current non-tax deductions and net-pay destinations provided by the user:

| Category | Amount per paycheck | Planning note |
| --- | ---: | --- |
| 401(k) contribution | $0.00 | Currently paused |
| Dental premium | $5.99 | Payroll deduction |
| HSA contribution | $60.00 | Payroll deduction |
| 401(k) loan payment | $208.40 | Payroll deduction |
| Bills checking account deposit | $1,375.00 | Split direct deposit |
| Daily-driver checking account deposit | $1,246.36 | Gas, groceries, and discretionary spending |
