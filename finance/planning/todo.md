...
- [x] On the main-checking report tab, add monthly total-spending line charts that can be switched by category with a radio-button selector in the pie-chart pane.
